<div class="container-fluid nav-fix p-0" style="z-index: 2;">
    <nav class="navbar navbar-expand-lg">
        <div class="container d-flex justify-content-between">
            <div class="d-inline-flex">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link sans text-white" href="/cart">Cart<span class="noti-red"
                        ...
                        <div class="dropdown">
                            <button class="nav-link user dropdown-toggle rounded" type="button"
            ...
            <div class="d-inline-flex">
                <form class="d-flex m-0" role="search" method="GET">
                    <input class="form-control sans me-2" name="search" type="search" placeholder="Search"
                        aria-label="Search">
